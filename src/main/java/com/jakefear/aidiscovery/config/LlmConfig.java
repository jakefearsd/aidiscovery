package com.jakefear.aidiscovery.config;
 ...
 *
 * This is a simplified configuration for discovery - only provides
 * the research model needed for topic expansion and analysis.
 */
@Configuration
public class LlmConfig {
    ...
    /**
     * Chat model configured for curation decisions (lowest temperature for consistency).
     * Used by AutonomousCurator for ACCEPT/REJECT/DEFER decisions.
     */
    @Bean
