...
import com.jakefear.aidiscovery.discovery.DiscoveryPhase;
import com.jakefear.aidiscovery.discovery.DiscoverySession;
import com.jakefear.aidiscovery.discovery.GapAnalyzer;
import com.jakefear.aidiscovery.discovery.RelationshipDepth;
...
public class DiscoveryInteractiveSession {
    ...
    private void printWelcome() {
        out.println();
        out.println("╔═══════════════════════════════════════════════════════════════════╗");
        out.println("║                AI DISCOVERY - DOMAIN DISCOVERY MODE               ║");
        out.println("║                                                                   ║");
