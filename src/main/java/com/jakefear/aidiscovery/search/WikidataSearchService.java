package com.jakefear.aidiscovery.search;
    ...
    public List<SearchResult> search(String query) {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header("User-Agent", "AIDiscovery/1.0 (https://github.com/jakefear/aidiscovery)")
                    .GET()
                    .build();
    ...
    private List<String> fetchEntityLabels(Set<String> entityIds) throws InterruptedException {
        ...
        try {
            ...
            for (String entityId : entityIds) {
                String label = entities.path(entityId).path("labels").path("en").path("value").asText();
